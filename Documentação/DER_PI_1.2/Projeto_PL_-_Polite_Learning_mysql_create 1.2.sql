...
CREATE TABLE `tb_tema` ( 
	...
	`imagem` varchar(255) NOT NULL,
	`mais_procurado` varchar(255) NOT NULL,
    `novidades_tema` varchar(255) NOT NULL,
	`categoria_tema` varchar(255) NOT NULL,
	PRIMARY KEY (`id_tema`)
);
...
select * from tb_post inner join tb_tema on tb_tema.id_tema = tb_post.fk_tema inner join tb_usuario on tb_usuario.id_usuario = tb_post.fk_usuario;